...
sourcesIndex["ferrous_chloride"] = {"name":"","dirs":[{"name":"literals","dirs":[],"files":["boolean.rs","identifier.rs","key.rs","number.rs","string.rs","whitespace.rs"]},{"name":"serde","dirs":[{"name":"de","dirs":[],"files":["list.rs","map.rs"]}],"files":["de.rs"]},{"name":"value","dirs":[],"files":["de.rs"]}],"files":["constants.rs","errors.rs","iter.rs","lib.rs","literals.rs","macros.rs","serde.rs","utils.rs","value.rs"]};
